          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                { <h1>{`Hi! I'm Munqiz Minhas `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Aspiring Data Analyst", "Software Developer", "Web Developer" ]'>
                <span className="wrap" style={{ display: "inline-block", transform: "translate3d(0, 0, 0)" }}>{text}</span>
                </span></h1>}
                
                {/* <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Aspiring Data Analyst", "Software Developer", "ML/AI Developer" ]'><span className="wrap">{text}</span></span></h1> } */}
