...
export const Banner = () => {
  ...
  const toRotate = [ "Aspiring Data Analyst", "Software Development", "Web Developer" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Munqiz Minhas`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Aspiring Data Analyst", "Software Development", "Web Developer" ]'><span className="wrap">{text}</span></span></h1>
